# Correct format
obs_list1 <- list(sit1=data.frame(Date=as.POSIXct(c("2009-11-30","2009-12-10")),
...
obs_list2 <- list(sit1=data.frame(var1=c(1.1,1.5),var2=c(NA,2.1)),
                 sit2=data.frame(Date=as.POSIXct(c("2009-11-30","2009-12-5")),
                                 var1=c(1.3,2)))
# Bad Date format
obs_list3 <- list(sit1=data.frame(Date=c("2009-11-30","2009-12-10"),
                                  var1=c(1.1,1.5),var2=c(NA,2.1)),
                 sit2=data.frame(Date=c("2009-11-30","2009-12-5"),
                                 var1=c(1.3,2)))
test_that("is.obs", {
...
sim_list1 <- list(sit1=data.frame(Date=as.POSIXct(c("2009-11-30","2009-12-10")),
                                  var1=c(1.1,1.5),var2=c(NA,2.1)),
                    it2=data.frame(Date=as.POSIXct(c("2009-11-30","2009-12-5")),
                                   var1=c(1.3,2)))
# Missing Date column
sim_list2 <- vector("list",2)
sim_list2 <- list(sit1=data.frame(Date=as.POSIXct(c("2009-11-30","2009-12-10")),
                                  var1=c(1.1,1.5),var2=c(NA,2.1)),
                      sit2=data.frame(var1=c(1.3,2)))
# Bad Date format
sim_list3 <- vector("list",1)
sim_list3 <- list(sit1=data.frame(Date=c("2009-11-30","2009-12-10"),
                                  var1=c(1.1,1.5),var2=c(NA,2.1)),
                  sit2=data.frame(Date=c("2009-11-30","2009-12-5"),
                                  var1=c(1.3,2)))
...
# Correct format
data_list1 <-list(sit1=data.frame(Date=as.POSIXct(c("2009-11-30","2009-12-10")),
                                   var1=c(1.1,1.5),var2=c(NA,2.1)),
                  sit2=data.frame(Date=as.POSIXct(c("2009-11-30","2009-12-5")),
                                  var1=c(1.3,2)))
# Missing Date column
data_list2 <- list(sit1=data.frame(var1=c(1.1,1.5),var2=c(NA,2.1)),
                  sit2=data.frame(Date=as.POSIXct(c("2009-11-30","2009-12-5")),
                                  var1=c(1.3,2)))
# Bad Date format
data_list3 <- list(sit1=data.frame(Date=c("2009-11-30","2009-12-10"),
                                   var1=c(1.1,1.5),var2=c(NA,2.1)),
                  sit2=data.frame(Date=c("2009-11-30","2009-12-5"),
                                  var1=c(1.3,2)))
# Relicates in Date column
data_list4 <- list(sit1=data.frame(Date=as.POSIXct(c("2009-11-30","2009-12-10",
                                                     "2009-12-10")),
                                   var1=c(1.1,1.5,2.3),var2=c(NA,2.1,NA)),
                   sit2=data.frame(Date=as.POSIXct(c("2009-11-30","2009-12-5")),
                                   var1=c(1.3,2)))
test_that("is.data", {
