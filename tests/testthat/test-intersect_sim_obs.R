obs_list <- list(sit1=data.frame(Date=as.POSIXct(c("2009-10-31","2009-11-10")),
                                 var1=rep(1,2),var2=c(NA,2)))
sim_list <- list(sit1=data.frame(Date=as.POSIXct(c("2009-10-31","2009-11-02",
...
test_that("intersect_sim_obs", {
  ...
  expect_true(all.equal(colnames(res$sim_list$sit1),
