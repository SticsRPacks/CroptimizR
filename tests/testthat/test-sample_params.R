...
test_that("sample_params", {
  ...
  expect_equal(CroptimizR:::sample_params(bounds_list, 2,seed=2),matrix(data=c(0.4075589,0.6488130, 1.213337, 1.915974, 2.528263, 2.028080),ncol=3,nrow = 2),tolerance=1e-3)
})
