...
#'
#' @param situation Vector of situations names for which results must be returned. 
#'
...
laitm_simple_wrapper <- function(param_values=NULL, situation, model_options, ...) {
...
test_wrapper(model_function = laitm_simple_wrapper, model_options = NULL, 
             param_values = c(inc_slope=25, dec_slope=10), situation = c("2005_a"))
...
tmp <- laitm_simple_wrapper(situation="2005_a", param_values = c(inc_slope=25, dec_slope=10))
...
```{r, eval=TRUE}
laitm_simple_wrapper_v2 <- function(param_values=NULL, situation, model_options, ...) {
