...
obs_list <- readRDS(
  system.file("extdata", "AgMIP_protocol", "vignette_data", "obs_list.Rds", package = "CroptimizR")
)
...
In this example, this file is named `agmip_protocol_vignette.xlsx` and is located in the `extdata/AgMIP_protocol` folder.
...
protocol_descr <- CroptimizR::load_protocol_agmip(
  protocol_file_path =
  system.file("extdata", "AgMIP_protocol", "agmip_protocol_vignette.xlsx", package = "CroptimizR")
)
...
obs_eval <- readRDS(
  system.file("extdata", "AgMIP_protocol", "vignette_data", "obs_eval.Rds", package = "CroptimizR")
)
```
...
load(file.path("AgMIP_protocol", "vignette_data", "sim_before_calib.Rdata"))
load(file.path("AgMIP_protocol", "vignette_data", "sim_post_calib.Rdata"))
```
