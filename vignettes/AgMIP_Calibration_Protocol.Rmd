...
Note that Wrappers already exist for several models (e.g. STICS, APSIM, SiriusQuality2, DSSAT, ...). For more details, see the package README
(https://sticsrpacks.github.io/CroptimizR/), or feel free to contact the authors.
...
knitr::include_graphics(
  system.file("extdata", "AgMIP_protocol", "vignette_data", "protocol_descr_file.png", package = "CroptimizR")
)
```
...
cat("<pre style='border:1px solid #ccc; padding:10px; max-height:300px; overflow:auto; background:#f8f8f8;'>",
    txt,
    "</pre>")
```
...
* `forced_param_values`: values of parameters not estimated during calibration,
...
knitr::include_graphics(
  system.file("extdata", "AgMIP_protocol", "vignette_data", "plot_MSE_Bias2_per_step.png", package = "CroptimizR")
)
```
...
knitr::include_graphics(
  system.file("extdata", "AgMIP_protocol", "vignette_data", "scatter_plots_after_step7.png", package = "CroptimizR")
)
```
