...
To use this feature, the model wrapper must be able to handle the `param_values` argument as a `tibble` with a `situation` column identifying the situations, allowing parameter values to differ across situations.
