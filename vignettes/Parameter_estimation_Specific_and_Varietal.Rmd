...
p <- plot(sim_before_optim$sim_list, obs= obs_list, type = "scatter",
          all_situations = TRUE)
...
file.copy(file.path(optim_options$out_dir, "EstimatedVSinit.pdf"),
          params$result_path, overwrite = TRUE)
file.copy(file.path(optim_options$out_dir, "optim_results.Rdata"),
          params$result_path, overwrite = TRUE)
file.copy(file.path(optim_options$out_dir, "sim_obs.png"),
          params$result_path, overwrite = TRUE)
```
