...
optim_options$maxeval <- 50 # Maximum number of evaluations of the 
                             # minimized criteria 
...
Complementary graphs and data are stored in the folder which path is given in `optim_options$path_results`. Among them, the `EstimatedVSinit.pdf` file contains the following figures: 
