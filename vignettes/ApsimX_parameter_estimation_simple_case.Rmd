...
sit_name="GattonRowSpacingRowSpace25cm"  # among "GattonRowSpacingRowSpace25cm",
...
optim_options$out_dir <- getwd() # path where to store the results
                                 # (graph and Rdata)
...
file.copy(file.path(optim_options$out_dir, "optim_results.Rdata"),
          params$result_path, overwrite = TRUE)
file.copy(file.path(optim_options$out_dir, "sim_obs_plots.png"),
          params$result_path, overwrite = TRUE)
```
