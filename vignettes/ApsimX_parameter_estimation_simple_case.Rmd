...
`param_info` determines the list of parameters that will be estimated in the parameter estimation process and associated bounds information (only uniform distributions for the moment, others will come soon).
