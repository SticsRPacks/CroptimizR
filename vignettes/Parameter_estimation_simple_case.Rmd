...
# For the moment read_obs_to_list is only able to read obs files in one folder ...
...
Same for crit_function: a value is set by default (log_concentrated_wss, see wallach et al., 2011). For the moment only 2 criterion are proposed (log_concentrated_wss and concentrated_wss, others will be proposed in next versions of CroptimizR. The user can implement its own criterion (see inputs and outputs required in the concentrated_wss function).
