...
The `estim_param` function returns a list which is also stored in the optim_results.Rdata file of the `optim_options$out_dir` folder. This list contains different information depending on the method used.
...
Complementary graphs and data are stored in the `optim_options$out_dir` folder. Among them, the EstimatedVSinit.pdf file containing the following figures:
