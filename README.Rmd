...
* An example of application of the AgMIP phase III protocol, designed to calibrate phenology of crop models, as described in detail in [Wallach et al (2022)](https://www.biorxiv.org/content/biorxiv/early/2022/08/29/2022.06.08.495355.full.pdf), is given [here](https://SticsRPacks.github.io/CroptimizR/articles/AgMIP_Calibration_Phenology_protocol.html).
