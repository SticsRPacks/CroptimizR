...
See [here](R/main_optim.R) for a detailed description of the input and output arguments of the main_optim function (or type "? main_optim" in an R console after having installed and loaded the SticsOptimizR package).
