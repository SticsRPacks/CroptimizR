...
See [here](https://sticsrpacks.github.io/CroptimizR/reference/main_optim.html) for a detailed description of the input and output arguments of the main_optim function (or type "? main_optim" in an R console after having installed and loaded the CroptimizR package).
