...
#' @param info_crit_values Values of the information criterion obtained so far for the different steps.
#'
...
#' @keywords internal
#'
summary_FwdRegAgMIP <- function(param_selection_steps, info_crit_list, path_results) {
